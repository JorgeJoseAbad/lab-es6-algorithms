...
class LetterSequence {
  ...
  static createSequence(sequence){
    console.log("createSequence sequence",sequence);
    //let characters      = sequence.split(""); ES5
    ...
    console.log("createSequence containerString: ",containerString);
    return containerString;
  }

  static decodeSequence (sequence){
    console.log("decodeSequence sequence: ",sequence);
    let containerString = "";
    ...
    console.log("decodeSequence containerString: ",containerString);
    return containerString;
  }
